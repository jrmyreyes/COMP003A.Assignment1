...
namespace COMP003A.Assignment1
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine(" ");
            Console.WriteLine("1. Last Name: Reyes");
            Console.WriteLine("2. First Name: Ron Jeremy");
            Console.WriteLine("3. Age: 22");
            Console.WriteLine("4. Place of birth: Philippines");
            Console.WriteLine("5. Nationality: Filipino");
            Console.WriteLine("6. Current Residency: CA, USA");
            ...
            Console.WriteLine("24. - Nier:Automata");
            Console.WriteLine("25. - Minecraft");
            Console.WriteLine("26. - Terraria");
            Console.WriteLine("27. - Raft");
            Console.WriteLine("28. - Don't starve together");
            Console.WriteLine("29. - Stardew Valley");
            Console.WriteLine("30. - Tekken 7");
            Console.WriteLine("31. - PUBG");
            Console.WriteLine("32. - Project Zomboid");
            Console.WriteLine("33. - No Man's Sky");
            Console.WriteLine("34. - Fallout 3");
            Console.WriteLine("35. - Fallout New Vegas");
            Console.WriteLine("36. - Fallout 4");
            Console.WriteLine("37. - Skyrim");
            Console.WriteLine("38. - Subnautica");
            Console.WriteLine("39. - MetalGear:V");
            Console.WriteLine("40. - Metal Gear Rising Revengeance");
            Console.WriteLine("41. - RE:2");
            Console.WriteLine("42. - RE:IV");
            Console.WriteLine("43. - RE:V");
            Console.WriteLine("44. - RE:VI");
            Console.WriteLine("45. - It Takes Two");
            Console.WriteLine("46. - A Way Out");
            Console.WriteLine("47. - The Forest");
            Console.WriteLine("48. - Dead Space 2");
            Console.WriteLine("49. - Dead Space 3");
            Console.WriteLine("50. - Rust");
            Console.WriteLine("51. - Dying Light");
            Console.WriteLine("52. - Dead Island");
            Console.WriteLine("53. - Left 4 Dead");
            Console.WriteLine("54. - Left 4 Dead 2");
            Console.WriteLine("55. - GTA:V");
            Console.WriteLine("56. - Hollow Knight");
